...
const hashTableChains = new HashTableChains();
hashTableChains.buildChains();
hashTableChains.put(0, 2);
hashTableChains.put(1, 1);
hashTableChains.put(2, 4);

hashTableChains.showDistro();

console.log(hashTableChains.get(1));
